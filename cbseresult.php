...
for ($rollno = 1600000; $rollno < 1600003; ++$rollno) {  // from which roll no to which roll no 
	...
	str_replace("", "", ""); // <- May be using this fucntion . khud soch or kuch possible h?
	
	if(!strpos($result, $error)) {
		$namepos = strpos($result, $namestring);
	}
	curl_close($handle);
}
